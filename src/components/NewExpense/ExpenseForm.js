...
const ExpenseForm = (props) => {
 // get  3 state for title, date, amount
 const [enteredTitle, setEnteredTitle] = useState('');
 const [enteredDate, setEnteredDate] = useState('');
 const [enteredAmount, setEnteredAmount] = useState('');

 //set 3 state with incoming props value
 ...
 /**
  * write a program on submit
  * 1.prevent default submit behaviour
  * 2.store all the data input
  * 3.call onSaveExpense function from newExpense data via props and store the saved input data
  * 4.clear inputs
  */
 const submitHandler = (e) => {
  e.preventDefault();
  console.log('Successfully prevented!');
  ...
  //call new SaveExpenseData from newExpense component here
